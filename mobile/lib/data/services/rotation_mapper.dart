...
double mapRotationToSteering(double accumulatedDegrees, int degrees) {
  final halfRange = degrees / 2;
  return (accumulatedDegrees / halfRange).clamp(-1.0, 1.0).toDouble();
}

double circularDelta(double from, double to) {
