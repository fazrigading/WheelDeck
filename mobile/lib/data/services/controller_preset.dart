...
enum GamePreset {
  ...
  static const Map<ControlId, String> ets2Keyboard = {
    ...
    ControlId.cameraInterior: '1',
    ControlId.cameraChasing: '2',
    ControlId.cameraTopdown: '3',
    ControlId.cameraRoof: '4',
    ControlId.cameraLeanout: '5',
    ControlId.dashboardInfo: 'I',
    // Shares 9 with camera view, mirroring the desktop InputMapper.
    ControlId.nextCamera: '9',
    ControlId.menu: 'Escape',
    ControlId.worldMap: 'M',
    ControlId.photoMode: '=',
    ControlId.activate: 'Enter',
