...
- Flags known limitations and upcoming work in completion summaries, referencing follow-up task IDs (e.g. "in-memory only, will be handled in TASK-018"). Confidence: 0.6
...
- References files in requests using @-mention syntax (e.g. `@CLAUDE.md`, `@docs/agents/`), expecting the agent to resolve them to repo paths. Confidence: 0.5
