...
The first-run setup check detects whether HIDMaestro (Windows) or uinput permissions (Linux) are configured. When the check fails, the app shows instructions and continues in a degraded state rather than blocking.
